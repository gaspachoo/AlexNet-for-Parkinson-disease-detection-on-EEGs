...
if __name__ == "__main__":
    ...
    medication = 'on'
    train = preload_dataset(folder_path,electrode_name,electrode_list_path,number_samples,"./Datasets_pt/train_sd_on.pt", medication)
    validate = preload_dataset(folder_path,electrode_name,electrode_list_path,number_samples, "./Datasets_pt/val_sd_on.pt",medication)
